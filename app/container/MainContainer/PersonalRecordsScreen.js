...
class PersonalRecordsScreen extends Component {
            ...
            {(val.title === selectedSkillMap) ? (
                val.item_img && val.item_img.length > 0 ?
                    (
                        ...
                        ></FlatList>
                    ) : (<Text style={newstyles.noItemAvail}>No records available</Text>)
            ) : null}
        </View>
    )
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={[newstyles.buttonViewStyle, { marginHorizontal: smartScale(2), marginTop: smartScale(1.4) }]}>
                    <TouchableOpacity>
                        <Icon name='trophy' size={smartScale(6)}></Icon>
                    </TouchableOpacity>
                    <View>
...
export default connect(null, {})(withLoader(PersonalRecordsScreen));
